...
public class EventLogPanel extends JPanel
	...
	private EventLogControlPanel createControls() {
		...
		// The ONE simulator handles messages too: this project doesn't need them
		/*
	...
	public void hostsConnected(DTNHost host1, DTNHost host2) {
		processEvent(conUpCheck, "Now in range:", host1, host2, null);
	}

	public void hostsDisconnected(DTNHost host1, DTNHost host2) {
		processEvent(conDownCheck, "Out of range:", host1, host2, null);
	}
