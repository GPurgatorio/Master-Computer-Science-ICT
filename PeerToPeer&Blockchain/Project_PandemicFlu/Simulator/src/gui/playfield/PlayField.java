...
public class PlayField extends JPanel {
	...
	private static boolean drawHotspots;
	private int hotspotsRange;
	private Color hotspotsBackground;
	...
	public PlayField (World w, DTNSimGUI gui) {
        ...
        this.hotspotsRange = s.getInt("HotspotRangeIndicator");
        try {
			this.hotspotsBackground = Color.decode(s.getSetting("HotspotHexColor"));
		}
        catch(Exception e) {
        	System.err.println("Hotspots background color (PandemicFlu.HotspotHexColor) was not a valid hex value. The default color [#9febf5] will be used");
        	this.hotspotsBackground = Color.decode("#9febf5");
		}
	...
	public static void setDrawHotspots(boolean draw) {
		drawHotspots = draw;
	}
	...
	public void paint(Graphics g) {
		...
		if(drawHotspots) {
			for(Coord c : SimScenario.hotspots) {
				g2.setColor(hotspotsBackground);
				g2.fillArc(PlayFieldGraphic.scale((int) c.getX() - hotspotsRange/2), PlayFieldGraphic.scale((int) c.getY() - hotspotsRange/2),
						PlayFieldGraphic.scale(hotspotsRange), PlayFieldGraphic.scale(hotspotsRange), 0, 360);
				g2.setColor(Color.BLACK);
				g2.drawArc(PlayFieldGraphic.scale((int) c.getX() - hotspotsRange/2), PlayFieldGraphic.scale((int) c.getY() - hotspotsRange/2),
						PlayFieldGraphic.scale(hotspotsRange), PlayFieldGraphic.scale(hotspotsRange), 0, 360);
			}
		}
		...
		g2.setColor(Color.BLACK);
		g2.drawRect(0,0, PlayFieldGraphic.scale(w.getSizeX()),
